...
public class demoController {
   ...
   @GetMapping (value="/hello", produces ="application/json" )
    public ResponseEntity<hello> Hello2(@RequestParam String nom)
    {
   ...
   @GetMapping (value="/helloSec", produces ="application/json" )
    public ResponseEntity<hello> Hello1(@RequestParam String nom, @RequestHeader("x-api-key") String apikey)
    {
